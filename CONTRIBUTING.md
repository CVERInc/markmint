...
| Type | How |
|---|---|
| Bug reports | Open an [Issue](https://github.com/CVERInc/vectorize/issues), include a reproducible image or steps |
...
| 種類 | 方法 |
|---|---|
| バグ報告 | [Issue](https://github.com/CVERInc/vectorize/issues) を作成、再現可能な画像 / 手順を添える |
